        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Origins_Regions_RegionId",
                        column: x => x.RegionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Coordinates_Origins_OriginId",
                        column: x => x.OriginId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Captures_Origins_OriginId",
                        column: x => x.OriginId,
                        principalTable: "Origins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Captures_Origins_OriginId1",
                        column: x => x.OriginId1,
                        principalTable: "Origins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Captures_Ports_PortId",
                        column: x => x.PortId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Captures_OriginId",
                table: "Captures",
                column: "OriginId");

            migrationBuilder.CreateIndex(
                name: "IX_Captures_OriginId1",
                table: "Captures",
                column: "OriginId1");

            migrationBuilder.CreateIndex(
                name: "IX_Captures_PortId",
                table: "Captures",
                column: "PortId");
